...
public class Member {
    ...
    public Member(int Id, String Role, String FName, String LName, int PNumber, boolean IsSuspended, int BorrowedItems, Date suspendDate, int Violations, int Suspensions) {
        this.setId(Id);
        this.setRole(Role);
        this.setFName(FName);
        this.setLName(LName);
